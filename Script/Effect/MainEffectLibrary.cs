...
public class MainEffectLibrary : MonoBehaviour {
    Vector3 mouse;
    ...
    void Start()
    {
        _gameObject[0] = (GameObject)Resources.Load("PlayerTouchEffect/PlayerTouchEffect 1");
    }
    ...
    void Update()
    {
        if (Input.GetMouseButtonDown(0))
        {
            ...
            mouse.z = 0;
            EffectInstantiate(MainEffectLibrary.Effect.TOUCH, mouse);
        }
    }
